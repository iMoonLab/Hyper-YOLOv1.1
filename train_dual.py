...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-c-hyper.yaml', help='model.yaml path')
    ...
    parser.add_argument('--device', default='1,2,3,4,5,6', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
